...
[data-baseweb="select"]>div,[data-testid="stTextInput"] input,[data-testid="stNumberInput"] input{background:#07121c!important;color:#fff!important;border:1px solid #263b4c!important;border-radius:8px!important;min-height:38px!important;height:38px!important;font-size:11px!important}
...
def _home(rankings:pd.DataFrame,roi:pd.DataFrame)->None:
    st.markdown('<div class="app-top"><span class="brand-wrap"><span class="brand">SHIVA INTELLIGENCE</span><span class="brand-sub">Your Draft Command Center</span></span><span class="top-icons">☰ &nbsp; ♧</span></div>',unsafe_allow_html=True)
    ...
    st.markdown('<a class="ask-home" href="?page=Shiva%20Intelligence" target="_self"><span class="ask-bot">🤖</span><span class="ask-copy"><span class="ask-title">ASK SHIVA GPT</span><span class="ask-sub">Ask questions, get advice, win your league.</span></span><span class="ask-arrow">›</span></a>',unsafe_allow_html=True)
