...
header,[data-testid="stHeader"],[data-testid="stToolbar"],[data-testid="stDecoration"],[data-testid="stStatusWidget"],[data-testid="stAppDeployButton"],.stDeployButton,#MainMenu,footer{display:none!important;height:0!important;min-height:0!important;visibility:hidden!important}
.block-container{max-width:520px!important;padding:8px 9px 82px!important;margin-top:0!important;overflow-x:hidden!important}
...
.app-top{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;padding:4px 2px 8px;margin:0}
.brand-wrap{display:block;min-width:0}.brand{display:block;font-size:18px;font-weight:1000;font-style:italic;color:#dfff00;letter-spacing:.08em;line-height:1.05;white-space:nowrap}.brand-sub{display:block;font-size:11px;color:#fff;margin-top:4px;line-height:1.1}.top-icons{display:block;font-size:20px;white-space:nowrap}
.home-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;margin:7px 0 10px}.home-card{min-height:100px;border-radius:10px;border:1px solid;padding:10px 6px;display:flex;flex-direction:column;justify-content:center;text-align:center;text-decoration:none!important;color:#fff!important}.home-icon{font-size:30px;line-height:1}.home-title{font-size:12px;font-weight:1000;margin-top:7px}.home-sub{font-size:9px;color:#e1e6ea;margin-top:3px}
.ask-home{display:grid!important;grid-template-columns:42px minmax(0,1fr) 22px!important;gap:9px!important;align-items:center!important;width:100%!important;box-sizing:border-box!important;background:linear-gradient(135deg,#08283e,#061827)!important;border:1px solid #0f6998!important;border-radius:10px!important;padding:10px 12px!important;margin:8px 0!important;min-height:66px!important;text-decoration:none!important;color:#fff!important}
.ask-home span{box-sizing:border-box!important}.ask-bot{display:block!important;font-size:28px!important;line-height:1!important}.ask-copy{display:block!important;min-width:0!important}.ask-title{display:block!important;font-size:15px!important;font-weight:1000!important;line-height:1.1!important;color:#fff!important}.ask-sub{display:block!important;font-size:10px!important;color:#d1e4ef!important;margin-top:4px!important;line-height:1.25!important}.ask-arrow{display:block!important;text-align:right!important;font-size:24px!important;line-height:1!important;color:#fff!important}
.league-card{background:#07131e;border:1px solid #24405a;border-radius:10px;padding:10px;margin:8px 0}.league-label{font-size:9px;color:#9fb0bd}.league-name{font-size:14px;font-weight:1000;margin-top:3px}.league-meta{font-size:10px;color:#d3dbe1;margin-top:3px}.page-head{text-align:center;font-size:22px;font-weight:1000;margin:2px 0}.page-sub{text-align:center;font-size:10px;color:#bdc8d1;margin-bottom:7px}.section-head{font-size:14px;font-weight:1000;color:#dfff00;margin:12px 0 5px}
...
.bottom-nav{position:fixed;left:50%;bottom:0;transform:translateX(-50%);width:min(520px,100vw);z-index:9999;background:rgba(2,8,13,.98);border-top:1px solid #163048;display:grid;grid-template-columns:repeat(5,1fr);padding:6px 4px max(7px,env(safe-area-inset-bottom));backdrop-filter:blur(12px)}.bottom-item{text-align:center;text-decoration:none!important;color:#d3dbe1!important;font-size:9px;font-weight:800}.bottom-icon{font-size:19px;display:block;margin-bottom:1px}.bottom-item.active{color:#dfff00!important}
.news-card{background:#07131d;border:1px solid #20394c;border-radius:9px;padding:8px;margin:5px 0}.news-title{font-size:11px;font-weight:900}.news-meta{font-size:8px;color:#9fb0bd;margin-top:3px}.news-desc{font-size:9px;color:#d1d9df;line-height:1.3;margin-top:4px}.inline-player-link{color:#dfff00!important;text-decoration:underline!important;font-weight:1000}
@media(max-width:390px){.block-container{padding-left:7px!important;padding-right:7px!important}.home-grid{gap:6px}.home-card{min-height:94px}.home-title{font-size:11px}.brand{font-size:16px}.brand-sub{font-size:10px}.ask-home{grid-template-columns:38px minmax(0,1fr) 18px!important;padding:9px 10px!important}.ask-bot{font-size:25px!important}.ask-title{font-size:14px!important}.ask-sub{font-size:9.5px!important}}
